...
export default function Hero() {
  return (
    <section className="relative w-full h-screen min-h-[700px] bg-[#080808] overflow-hidden">
      ...
      {/* LEFT COPY */}
      <motion.div
        className="absolute left-8 sm:left-12 lg:left-[72px] top-1/2 -translate-y-1/2 z-20 max-w-[320px]"
        initial="hidden"
        animate="visible"
      >
        {/* Eyebrow */}
      ...
      {/* RIGHT COPY */}
      <motion.div
        className="absolute right-8 sm:right-12 lg:right-[72px] top-1/2 -translate-y-1/2 z-20 text-right max-w-[200px] hidden md:block"
        initial="hidden"
        animate="visible"
      >
        {/* SPF ghost */}
      ...
      {/* BOTTOM BAR */}
      <motion.div
        className="absolute bottom-7 left-8 sm:left-12 lg:left-[72px] right-8 sm:right-12 lg:right-[72px] flex items-center z-20"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
